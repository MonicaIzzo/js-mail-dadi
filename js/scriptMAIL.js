...
**1** Prepararo l'arrey che contiente tutti gli indirizzi verificati.
...
// # 1 Prepararo l'arrey
const allowedEmails = [
  "cristina@verderamina.it",
  "info@monicaizzo.net",
  "ciroserver@libero.it",
  "monicaizzo.adv@gmail.com",
  "info@tattikats.com",
  "info@degustibus.re.it",
];
